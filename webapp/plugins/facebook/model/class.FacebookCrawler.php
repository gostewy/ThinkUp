            ...
            if (isset($stream->data) && is_array($stream->data) && sizeof($stream->data) > 0) {
                ...
                if (isset($stream->paging->next)  && strtotime ($stream->data[count($stream->data) -1]->created_time ) > strtotime("-6 months")
                   ...
                   // $next_api_request = $stream->paging->next . '&since=' . $since;
                    ...
                    $this->logger->logInfo("Facebook stopping; have gone back the max time ",
                        __METHOD__.','.__LINE__);
...
*/
               ...
               // $must_process_comments = true;
                        ...
                        do {
                            ...
                            if (isset($comments_stream) && isset($comments_stream->data) && is_array($comments_stream->data)) {
                                ...
                                if (isset($comments_stream->paging->next) ) {
                                    ...
                                    $comments_stream = FacebookGraphAPIAccessor::rawApiRequest($comments_stream->paging->next);
                ...
                if ($must_process_likes) {
                        ...
                        do {
                            $failover = $failover + 1;
                            //nobody likes us that much for now.
                            if($failover > 100) {
                            ...
                            if (isset($likes_stream) && is_array($likes_stream->data)) {
                                ...
                                if(isset($likes_stream->paging->next)) {
                                    ...
                                    $likes_stream = FacebookGraphAPIAccessor::rawApiRequest($likes_stream->paging->next);
                                }
